...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  ...
  const icons: { [key: string]: React.ReactElement } = {
    ...
    scissors: <path strokeLinecap="round" strokeLinejoin="round" d="M6.166 13.834L3.75 11.418a2.25 2.25 0 010-3.182l2.416-2.416m8.418 5.598l2.416-2.416a2.25 2.25 0 000-3.182l-2.416-2.416M12 6.343L13.834 4.5m-3.668 1.843L8.332 4.5m5.502 4.093L12 6.343m0 0l-1.834-1.843M12 17.657l1.834 1.843m-3.668-1.843l1.834 1.843m-1.834-1.843L8.332 19.5m5.502-4.093L12 17.657m0 0l1.834 1.843" />,
    grid: <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 8.25V6zM3.75 14.25A2.25 2.25 0 016 12h2.25a2.25 2.25 0 012.25 2.25v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25v-2.25zM13.5 6A2.25 2.25 0 0115.75 3.75h2.25A2.25 2.25 0 0120.25 6v2.25a2.25 2.25 0 01-2.25 2.25h-2.25A2.25 2.25 0 0113.5 8.25V6zM13.5 14.25A2.25 2.25 0 0115.75 12h2.25a2.25 2.25 0 012.25 2.25v2.25a2.25 2.25 0 01-2.25 2.25h-2.25a2.25 2.25 0 01-2.25-2.25v-2.25z" />,
    consultant: <path strokeLinecap="round" strokeLinejoin="round" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />,
    ruler: <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l7.5-7.5 7.5 7.5M4.5 12.75v6.75h15v-6.75M4.5 19.5v-6.75" />,
    hair: <path strokeLinecap="round" strokeLinejoin="round" d="M6 18c0-3.31 2.69-6 6-6s6 2.69 6 6M8 8c0-2.21 1.79-4 4-4s4 1.79 4 4" />,
    makeup: <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 3L16 5l-10 10-1.5-1.5L14.5 3zM9 13l-1.5 1.5L3 10l1.5-1.5L9 13zm7 2l-1.5 1.5-2-2L14 13l2 2z" />,
    earrings: <path strokeLinecap="round" strokeLinejoin="round" d="M12 22a2 2 0 100-4 2 2 0 000 4zm0-10C5.5 12 2 8.5 2 5s3.5-7 10-7 10 3.5 10 7-3.5 7-10 7z" />,
    'color-palette': <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18zM3.62 7.5h16.76M3.62 16.5h16.76M7.5 3.62v16.76M16.5 3.62v16.76M12 12l-2.83-2.83M12 12l2.83-2.83M12 12l-2.83 2.83M12 12l2.83 2.83" />,
    'credit-card': <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m3-5.25h.008v.008H12v-.008zm3.75 0h.008v.008H15.75v-.008zm3.75 0h.008v.008H19.5v-.008zM4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />,
