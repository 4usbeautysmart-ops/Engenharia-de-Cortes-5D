...
export default function App() {
  ...
  const handleLogin = (isUserAdmin: boolean = false) => {
                ...
                {activeTab === 'colorist' && (
                     coloristReport ? (
                        <ColoristReportDisplay 
                            reportData={{ report: coloristReport.report, tryOnImage: coloristReport.tryOnImage }} 
                        ...
                        <div className="p-6">
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-gray-700/30 rounded-xl p-4 flex flex-col min-h-[450px]" id="colorist-client-photo-container">
                                    <h3 className="text-lg font-semibold mb-4 text-emerald-300">1. Foto da Cliente</h3>
                                    <div className="flex-grow">
                                        <ImageInput onImageUpload={setClientImageForColor} />
                                    </div>
                                </div>
                                <div className="bg-gray-700/30 rounded-xl p-4 flex flex-col min-h-[450px]" id="colorist-inspiration-container">
                                    ...
                                    <div className="flex-grow flex flex-col gap-4">
                                        <div className="h-64 mb-4">
                                            <ImageInput onImageUpload={setColoristReferencePhoto} />
                                        </div>
                                        <textarea 
